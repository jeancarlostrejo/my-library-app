<div class="dark:text-gray-100 text-gray-900">
    <div class="max-w-7xl mx-auto">
        <form wire:submit='dataSearch'>
            <div class="md:grid md:grid-cols-3 gap-5 items-center">
                ...
                <div class="my-5 px-2 lg:px-0 flex items-center">
                    <input type="submit"
                        class="bg-blue-600 hover:bg-blue-700 transition-colors text-white text-sm font-bold px-10 py-2 rounded cursor-pointer uppercase w-full md:w-auto"
                        value="Buscar" />
                </div>
            </div>
        </form>
